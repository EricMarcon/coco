...
Les fonctions suivantes s'appliquent à chaque quadrat, défini par sa sous-parcelle et son numéro d'ordre, le couple `(quadrat_x,quadrat_y)` qui va de (0, 0) à (9,9).
